module.exports = [
    ...
    },
    {
        ...
        data:[
                ...
                {
                name: 'Forgiveness',
                product_id: 'rv.verse.collection.forgiveness',
                show: 'true',
                num_verses: '50',
                num_chapters: '0',
                color: '#1a4bb0'
                ...
                {
                name: 'Peace',
                product_id: 'rv.verse.collection.peace',
                show: 'true',
                num_verses: '50',
                num_chapters: '0',
                color: '#dba8ee'
    ...
    },
    {
        ...
        data:[
                ...
                product_id: 'rv.combo.book.genesis.psalms.1000_hints',
                show: 'true',
                price: '$3.49',
                color: '#4ab919',
                num_verses: ['100', '100', ''],
                ...
                product_id: 'rv.combo.book.matthew.revelation.500_hints',
                show: 'true',
                price: '$2.49',
                color: '#536ac0',
                num_verses: ['50', '50', ''],
                ...
                product_id: 'rv.combo.book.exodus.john.500_hints',
                show: 'true',
                price: '$2.49',
                color: '#aa22a5',
                num_verses: ['50', '50', ''],
