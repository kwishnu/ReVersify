                ...
                <View style={[intro_styles.footer, this.footerBorder(this.state.bgColor), this.headerFooterColor(this.state.bgColor)]}>
                        <View style={{flexDirection: 'row', justifyContent: 'space-between', width: width}}>
                            ...
                            <View style={{padding: height*.015}}>
                                <Text style={[intro_styles.footer_text, {color: '#2b0b30'}]}>Skip</Text>
                            </View>
                        </View>
                </View>
                 ...
                 { this.state.showTiles &&
                    <View style={intro_styles.tiles_container}>
                       <View style={intro_styles.tile_row} >
                            ...
                            <IntroTile ref={(b) => { this.b = b; }} text={ 'sandt' } nextFrag={ this.state.nextFrag } onDrop={ (text)=>{ this.onDrop(text); }} sounds={ this.state.useSounds }/>
                            <IntroTile ref={(c) => { this.c = c; }} text={ 'edtheh' } nextFrag={ 'edtheh' } onDrop={ (text)=>{ this.onDrop(text); }} sounds={ this.state.useSounds }/>
                        </View>
                        <View style={intro_styles.tile_row} >
                            <IntroTile opac={0} ref={(d) => { this.d = d; }} text={ 'taerc' } nextFrag={ 'creat' } onDrop={ (text)=>{ this.onDrop(text); }} sounds={ this.state.useSounds }/>
                            <IntroTile ref={(e) => { this.e = e; }} text={ 'eaven' } nextFrag={ this.state.nextFrag } onDrop={ (text)=>{ this.onDrop(text); }} sounds={ this.state.useSounds }/>
                        ...
                        <View style={intro_styles.tile_row} >
                            <IntroTile ref={(g) => { this.g = g; }} text={ 'heearth' } nextFrag={ this.state.nextFrag } onDrop={ (text)=>{ this.onDrop(text); }} sounds={ this.state.useSounds }/>
                        </View>
                    </View>
                }
            </View>
